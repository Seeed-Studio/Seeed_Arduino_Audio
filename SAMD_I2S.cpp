...
*/
/**************************************************************************/
SAMD_I2S::SAMD_I2S(uint8_t FS_PIN, uint8_t SCK_PIN,
...
*/
/**************************************************************************/
bool SAMD_I2S::begin(I2SSlotSize width, int fs_freq, int mck_mult) {
  ...
  // CLKCTRL[1] is used for the rx channel
  I2S->CLKCTRL[1].reg =
      I2S_CLKCTRL_MCKSEL_GCLK | I2S_CLKCTRL_MCKOUTDIV(mckoutdiv / 2) |
      I2S_CLKCTRL_MCKDIV(mckdiv / 2) | I2S_CLKCTRL_SCKSEL_MCKDIV |
      I2S_CLKCTRL_BITDELAY_LJ |
      I2S_CLKCTRL_FSWIDTH_SLOT | I2S_CLKCTRL_NBSLOTS(1) |
      I2S_CLKCTRL_SLOTSIZE(I2S_CLKCTRL_SLOTSIZE_32);  
  // I2S->CLKCTRL[1].bit.NBSLOTS = 0;
  ...
  I2S->RXCTRL.reg = I2S_RXCTRL_DMA_SINGLE | I2S_TXCTRL_MONO_STEREO |
...
/*!
   ...
   enabled on an SAMD_I2S instance, while on SAMD51 the same
   SAMD_I2S instance can have both rx and tx channels enabled.
*/
/**************************************************************************/
void SAMD_I2S::enableTx() {
#if defined(__SAMD51__)
...
void SAMD_I2S::enablePDMRx() {
  ...
  //                   I2S_RXCTRL_BITREV_MSBIT | I2S_RXCTRL_EXTEND_ZERO |
  //                   I2S_RXCTRL_WORDADJ_RIGHT | I2S_RXCTRL_DATASIZE(I2S_RXCTRL_DATASIZE_32) |
  //                   I2S_RXCTRL_SLOTADJ_RIGHT | I2S_RXCTRL_CLKSEL_CLK0 |
  ...
  I2S->RXCTRL.reg = I2S_RXCTRL_DMA_SINGLE | I2S_RXCTRL_MONO_STEREO |
                    I2S_RXCTRL_BITREV_MSBIT | I2S_RXCTRL_EXTEND_ZERO |
                    I2S_RXCTRL_WORDADJ_RIGHT | I2S_RXCTRL_DATASIZE(I2S_RXCTRL_DATASIZE_32) |
                    I2S_RXCTRL_SLOTADJ_RIGHT | I2S_RXCTRL_CLKSEL_CLK1 |
                    I2S_RXCTRL_SERMODE_RX;    
...
*/
/**************************************************************************/
void SAMD_I2S::write(int32_t left, int32_t right) {
#if defined(__SAMD51__)
...
*/
/**************************************************************************/
void SAMD_I2S::read(int32_t *left, int32_t *right) {
#if defined(__SAMD51__)
